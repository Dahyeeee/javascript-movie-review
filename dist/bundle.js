...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _Movie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Movie */ \"./src/domain/Movie.ts\");\n/* harmony import */ var _constant_movieConstants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../constant/movieConstants */ \"./src/constant/movieConstants.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\r\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\r\n    return new (P || (P = Promise))(function (resolve, reject) {\r\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\r\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\r\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\r\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\r\n    });\r\n};\r\n\r\n\r\nclass MovieManager {\r\n    constructor() {\r\n        this.state = {\r\n            status: _constant_movieConstants__WEBPACK_IMPORTED_MODULE_1__.apiStatus.LOADING,\r\n            data: {},\r\n        };\r\n        this.subscribers = [];\r\n    }\r\n    subscribe(subscriber) {\r\n        this.subscribers.push(subscriber);\r\n    }\r\n    publish(state) {\r\n        this.subscribers.forEach((subscriber) => {\r\n            subscriber(state);\r\n        });\r\n    }\r\n    setNewState(newState) {\r\n        this.state = Object.assign(Object.assign({}, this.state), newState);\r\n        this.publish(this.state);\r\n    }\r\n    showMovies(searchWord = \"\") {\r\n        return __awaiter(this, void 0, void 0, function* () {\r\n            this.setNewState({ status: _constant_movieConstants__WEBPACK_IMPORTED_MODULE_1__.apiStatus.LOADING });\r\n            const movieAppData = yield _Movie__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getMovies(searchWord);\r\n            const newState = {\r\n                status: movieAppData.error ? _constant_movieConstants__WEBPACK_IMPORTED_MODULE_1__.apiStatus.FAILURE : _constant_movieConstants__WEBPACK_IMPORTED_MODULE_1__.apiStatus.SUCCESS,\r\n                data: movieAppData,\r\n            };\r\n            this.setNewState(newState);\r\n        });\r\n    }\r\n    showMoreMovies() {\r\n        return __awaiter(this, void 0, void 0, function* () {\r\n            this.setNewState({ status: _constant_movieConstants__WEBPACK_IMPORTED_MODULE_1__.apiStatus.LOADING });\r\n            const movieAppData = yield _Movie__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getMoreMovies();\r\n            const newState = {\r\n                status: movieAppData.error ? _constant_movieConstants__WEBPACK_IMPORTED_MODULE_1__.apiStatus.FAILURE : _constant_movieConstants__WEBPACK_IMPORTED_MODULE_1__.apiStatus.SUCCESS,\r\n                data: movieAppData,\r\n            };\r\n            this.setNewState(newState);\r\n        });\r\n    }\r\n    openItemModal(id) {\r\n        const modalMovieData = _Movie__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getMovie(id);\r\n        this.setNewState({ data: modalMovieData });\r\n    }\r\n}\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new MovieManager());\r\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/domain/MovieManager.ts?");
